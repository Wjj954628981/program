  ...
  private JTextField jtfResult1 = new JTextField(6);
    ...
    panel2.add(panel22);
		...
		jbtCompute.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {			
				int count = new ComputePrime(Integer.parseInt(jtfLimit2.getText()),jtfResult1).getNumberOfPrimes(
	...
	/** Task class for SwingWorker */
	 class ComputePrime extends SwingWorker<Integer, Object> {
		private int limit; 
		...
		public  int getNumberOfPrimes(int limit) {		
