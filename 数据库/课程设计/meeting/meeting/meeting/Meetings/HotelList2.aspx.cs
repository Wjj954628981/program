...
namespace Meeting.Meetings
{
    ...
    public partial class HotelList2 : System.Web.UI.Page
    {
        public int number;
        ...
        protected void HotelRepeater_ItemCommand(object source, RepeaterCommandEventArgs e)
        {
            ...
            {
                case "Modify":
                    Response.Redirect("HotelAdd2.aspx?Opera=Edit&&HId=" + int.Parse(e.CommandArgument.ToString()));
                    break;
                case "Delete":
                    string h_id = e.CommandArgument.ToString();
                    mbll.DeleteHotel(h_id);
                    Response.Redirect("HotelList2.aspx");
                    break;
            }
        }
        ...
        {
            Response.Redirect("HotelAdd2.aspx?Opera=Add");
        }
    }
}