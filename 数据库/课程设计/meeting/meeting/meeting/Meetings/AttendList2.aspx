<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AttendList2.aspx.cs" Inherits="meeting.Meetings.AttendList2" %>
        ...
        <asp:Repeater ID="AttendRepeater" runat="server" OnItemCommand="AttendRepeater_ItemCommand" OnItemDataBound="AttendRepeater_DataBound">
            ...
            <ItemTemplate>
                <tr>
                    ...
                    <td style="text-align:center">
                        <asp:Button ID="btnPerson2" runat="server" CommandArgument='<%# Eval("participator_id")+","+Eval("m_id") %>' CommandName="Check2" TEXT="查看陪同人员"/>
                    </td>
                </tr>
            </ItemTemplate>
            <FooterTemplate>
