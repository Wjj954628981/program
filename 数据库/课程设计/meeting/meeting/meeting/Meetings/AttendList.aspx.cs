...
{
    public partial class AttendList : System.Web.UI.Page
    {
        ...
        protected void AttendRepeater_ItemCommand(object source, RepeaterCommandEventArgs e)
        {
            switch (e.CommandName)
            {
                case "Modify2":
                    ...
                    Response.Redirect("AttendAdd.aspx?Opera=Edit&&PARTICIPATORId="+int.Parse(arg1[0])+"&&MId="+int.Parse(arg1[1]));
                    break;
                case "Delete2":
                ...
                case "Check2":
                    ...
                    Response.Redirect("AccompanyList.aspx?Opera=Check&&PARTICIPATORId=" + int.Parse(arg3[0]) + "&&MId=" + int.Parse(arg3[1]));
                    break;
            }
        }
        ...
        {
            int MId = int.Parse(Request.QueryString["MId"]);
            Response.Redirect("AttendAdd.aspx?Opera=Add&&MID="+MId);
        }
